function main(config) {
  ...
  let black_rules = `{"rules": ["RULE-SET,applications,DIRECT", "DOMAIN,clash.razord.top,DIRECT", "DOMAIN,yacd.haishan.me,DIRECT", "RULE-SET,private,DIRECT", "RULE-SET,reject,REJECT", "RULE-SET,tld-not-cn,CSPROXY", "RULE-SET,gfw,CSPROXY", "RULE-SET,telegramcidr,CSPROXY", "MATCH,DIRECT"]}`
  config['rules'] = JSON.parse(black_rules)['rules']
